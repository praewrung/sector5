...
var AuthController = exports.AuthController = function () {
    AuthController.$inject = ["$http", "$window", "AuthService", "UserService", "$location", "$rootScope", "FlashService"];
    function AuthController($http, $window, AuthService, UserService, $location, $rootScope, FlashService) {
        "ngInject";
        ...
        console.log("sss => " + this.isUserLoggedIn);
    }
    ...
    _createClass(AuthController, [{
        ...
        value: function register() {
            ...
            this._UserService.Create(this.user).then(function (response) {
                alert("asd");
                if (response.success) {
                    alert("a");
                    //this._FlashService.Success('Registration successful', true);
                    _this2._$location.path('/home');
                } else {
                    // this._FlashService.Error(response.message);
...
var AuthService = exports.AuthService = function () {
    ...
    _createClass(AuthService, [{
        ...
        value: function signin(username, password) {
            ...
            //        this._$http.post('http://localhost:8000/authenticate', { username, password }).then(
            //            (respond) => {
            ...
            if (username == "praewrung") {
                if (password == "prawrung") {
                    this.localStorage.token = "abxcd";
        ...
        value: function hasPermissionForView(view) {
            ...
            angular.forEach(view.data.permissions, function (permission) {
                if (_this.profile.permissions.indexOf(permission) >= 0) {
                    found = true;
                    return;
                }
            });
...
angular.module("MainApp", ["uiRouterStyles", "templates", "Home", "Cart", "Community", "Downtown", "Help", "Search", "Setting", "Signin", "Auth", "Directives", "Signout"]);
